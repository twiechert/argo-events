...
func (c *FakeSensors) UpdateStatus(sensor *v1alpha1.Sensor) (*v1alpha1.Sensor, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(sensorsResource, "status", c.ns, sensor), &v1alpha1.Sensor{})
