...
func (c *ArgoprojV1alpha1Client) Events(namespace string) EventInterface {
...
func (c *ArgoprojV1alpha1Client) Triggers(namespace string) TriggerInterface {
	return newTriggers(c, namespace)
}

func (c *ArgoprojV1alpha1Client) Wires(namespace string) WireInterface {
	return newWires(c, namespace)
}
